...
Eureka moment. That is one of the fundamental motivations for studying mathematics. Specifically, I believe that we can encounter eureka moments by identifying unknown solutions of partial differential equations (PDEs) from known data. Accordingly, my research topics are: 1) machine learning methodology for fast and general-purpose PDE solvers; and 2) the mathematical modeling and simulation of ocean wave dynamics. [qwe](https://academicpages.github.io/files/paper3.pdf) [Academic Pages template](https://github.com/academicpages/academicpages.github.io)
